...
export async function up(knex: Knex): Promise<void> {
  ...
  await knex.schema.createTable('oauth_client_scopes', (table) => {
    table
  ...
  await knex.raw(`
    INSERT INTO oauth_client_scopes (oauth_client_id, scope_id)
    SELECT legacy.oauth_client_id, scope.id
    FROM oauth_client_allowed_scopes AS legacy
    INNER JOIN oauth_scopes AS scope ON scope.key = legacy.scope
